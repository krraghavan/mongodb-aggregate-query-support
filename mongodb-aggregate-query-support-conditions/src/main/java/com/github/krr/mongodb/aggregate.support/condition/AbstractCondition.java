...
public abstract class AbstractCondition implements Condition {
  ...
  protected int getParameterIndex(AnnotatedTypeMetadata annotatedTypeMetadata) {
    ...
    if(params == null || !params.containsKey(ConditionalAnnotationMetadata.PARAMETER_INDEX)) {
      throw new IllegalStateException("Could not find parameter with key " + ConditionalAnnotationMetadata.PARAMETER_INDEX);
    }
