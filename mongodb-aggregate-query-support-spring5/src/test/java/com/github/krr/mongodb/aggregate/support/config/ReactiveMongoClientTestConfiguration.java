...
public class ReactiveMongoClientTestConfiguration {
  ...
  public ReactiveMongoClientTestConfiguration()  {
  ...
  public MongoClient mongoClient() throws IOException {
    ...
    ClusterSettings clusterSettigns = ClusterSettings.builder()
                                                     .hosts(singletonList(serverAddress))
                                                     .requiredClusterType(STANDALONE)
                                                     .build();
    MongoClientSettings settings = MongoClientSettings.builder()
                                                      .applyToClusterSettings(c -> c.applySettings(clusterSettigns)).build();
