...
import com.github.krr.mongodb.aggregate.support.repository.nonreactive.TestBucketRepository;
...
@SuppressWarnings({"Duplicates", "unchecked", "FieldCanBeLocal"})
...
public class AggregateBucketTest extends AbstractTestNGSpringContextTests {
  ...
  private void setupRepository() throws IOException {
    ...
    bucketRepository.saveAll(artworks);
  }
