...
public class NonReactiveAggregateQuerySupportingRepositoryFactory extends MongoRepositoryFactory {
  ...
  private class AggregateQueryLookupStrategy implements QueryLookupStrategy {
    ...
    public RepositoryQuery resolveQuery(Method method, RepositoryMetadata repositoryMetadata,
      ...
      if (!isAggregateQueryAnnotated(method)) {
        ...
        return new NonReactiveAggregateMongoQuery(method, repositoryMetadata, mongoOperations, projectionFactory, queryExecutor, beanFactory);
      }
    }
  }
  ...
  public void setBeanFactory(BeanFactory beanFactory) throws BeansException {
    ...
    if(beanFactory instanceof ListableBeanFactory) {
      ...
      throw new UnsupportedOperationException("Aggregate query needs instance of ListableBeanFactory");
    }
  }
