...
public class CollectionNameAnnotationTest extends AggregateCountTest {
  ...
  @Test
  public void mustReturnScoresFromDynamicallyCreatedScoresCollection() throws IOException {
  ...
  public void mustThrowExceptionIfMultipleCollectionNameAnnotationsPresentOnMethod() throws IOException {
    String collName = RandomStringUtils.randomAlphabetic(10);
    List<Score> scores = getScoresDocuments();
    // insert scores into a random collection
    mongoTemplate.insert(scores, collName);
  ...
  @Test(expectedExceptions = IllegalArgumentException.class)
  public void mustThrowExceptionIfMultipleCollectionNameAnnotationsPresentOnMethod2() throws IOException {
    String collName = RandomStringUtils.randomAlphabetic(10);
    List<Score> scores = getScoresDocuments();
    // insert scores into a random collection
    mongoTemplate.insert(scores, collName);
