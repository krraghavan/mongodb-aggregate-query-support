 ...
 * 10/10/2015.
 */
public class AggregateQuerySupportingRepositoryFactory extends ReactiveMongoRepositoryFactory {
   ...
   */
  public AggregateQuerySupportingRepositoryFactory(ReactiveMongoOperations mongoOperations,
