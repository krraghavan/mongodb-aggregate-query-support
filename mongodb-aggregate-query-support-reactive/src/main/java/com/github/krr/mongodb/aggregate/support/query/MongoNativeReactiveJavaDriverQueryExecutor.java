...
public class MongoNativeReactiveJavaDriverQueryExecutor implements MongoQueryExecutor {

  private static final Logger LOGGER = LoggerFactory.getLogger(MongoNativeReactiveJavaDriverQueryExecutor.class);
  ...
  public MongoNativeReactiveJavaDriverQueryExecutor(ReactiveMongoOperations mongoOperations) {
