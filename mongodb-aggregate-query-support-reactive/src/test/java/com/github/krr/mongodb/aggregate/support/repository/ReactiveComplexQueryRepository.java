...
public interface ReactiveComplexQueryRepository extends ReactiveMongoRepository<DummyBean, Integer> {
  ...
  Flux<DummyBean> findMappingsByTypeAndVersion(String version, MappingType type);
  ...
  @Project(
      query =
          ...
          + "}",
      order = 10)
  Mono<DummyBean> getPrefixesAggQuery(
      Long epochWid, // 0
